...
import { BarChart3, Boxes, Coffee, Home, PackageOpen, Route, Settings, Shield, ShoppingCart, Users, WalletCards, Wheat, Database } from "lucide-react"
...
const nav = [
  ...
  { href: "/admin", label: "CRUD completo", icon: Database, perms: ["admin.crud.read"] },
    ...
    <aside className="sticky top-0 hidden h-screen w-[292px] shrink-0 overflow-y-auto border-r border-zinc-200 bg-white px-4 py-5 md:block">
      <div className="flex items-center gap-3 px-2">
        <div className="h-10 w-10 overflow-hidden rounded-full bg-black">
          <Image src="/brand/logo-panaderia-rincon.png.jpeg" alt="Panadería Rincón" width={40} height={40} className="h-10 w-10 object-contain" priority />
        </div>
        <div>
