...
PRODUCTS = TableConfig(
    ...
    id_prefix="prod",
    label="Productos",
    allowed_create=("id", "nombre", "categoria", "unidad_venta", "precio_venta", "costo_unitario", "activo"),
    allowed_patch=("nombre", "categoria", "unidad_venta", "precio_venta", "costo_unitario", "activo"),
